...
import { productBarcodeBindings } from "@/lib/business";
...
export default function ProductsPage() {
  ...
  const filtered = useMemo(() => state.products.filter((product) => {
    ...
    if (status === "Sem custo" && product.cost > 0) return false;
